...
impl Point {
    ...
    pub const fn new_position(x: f64, y: f64, z: f64) -> Self {
        Self { x, y, z, w: 1.0 }
    }
    pub const fn new_direction(x: f64, y: f64, z: f64) -> Self {
        Self { x, y, z, w: 0.0 }
    }
    pub const fn from_val(v: f64, w: f64) -> Self {
        Self {
            x: v,
            y: v,
            z: v,
    ...
    */
    ...
    pub fn antidot(self, rhs: Point) -> f64 {
        self.w * rhs.w
    }
